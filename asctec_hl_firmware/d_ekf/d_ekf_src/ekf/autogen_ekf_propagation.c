  ...
  real32_T eml_x_new[16])
{
  ...
  eml_t262 = eml_in1[6]*eml_in1[6];//rt_pow32_snf(eml_in1[6], 2.0F);
  eml_t263 = eml_in1[7]*eml_in1[7];//]rt_pow32_snf(eml_in1[7], 2.0F);
  eml_t264 = eml_in1[8]*eml_in1[8];//rt_pow32_snf(eml_in1[8], 2.0F);
  eml_t265 = eml_in1[9]*eml_in1[9];//rt_pow32_snf(eml_in1[9], 2.0F);
