...
matlabFunction(q_out, 'file', 'autogen_mul_quat', 'vars', {q1, q2})
add_eml_compliance('autogen_mul_quat.m')
...
emlc  -T RTW -c  -v -s hw_impl -o pos_ekf -d d_ekf_src/ekf... 
    ...
    autogen_mul_quat -eg {vec_4_props, vec_4_props}
%     hl_ekf_propagation -eg {vec_3_props, vec_3_props, vec_3_props, vec_3_props, vec_4_props, vec_3_props, vec_3_props, scalar_props}
